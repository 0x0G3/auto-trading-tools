...
export default function Navbar() {
  const { address, isConnected } = useAuth(); // ✅ Get wallet info

  console.log("Connected Wallet Address:", address); // ✅ Debugging output
  ...
  return (
    <div>
      <div className="navbar bg-base-100 px-6 shadow-md">
        ...
        {/* Right Section: Wallet Connection & Address Display */}
        <div className="flex-none">
